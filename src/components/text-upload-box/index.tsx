...
import {createPdf, createText} from "@/@core/api/asset-api";
...
const TextUploadBox = () => {
    ...
    const onChangeFiles = useCallback(async (e: ChangeEvent<HTMLInputElement> | any) => {
        ...
        console.log('filesize : ', selectedFiles.size);

        if (!checkExtension(selectedFiles, 'text/plain')) {
        ...
        const response = await createText(selectedFiles);
